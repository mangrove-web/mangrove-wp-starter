...
if( !function_exists("theme_styles") ) {
	function theme_styles() {
		...
		// npm gulp is setup for compiling. See package.json
		wp_register_style( 'project-custom', get_template_directory_uri() . '/library/styles/css/project-custom.css', array(), '1.0', 'all' );
		wp_enqueue_style( 'project-custom' );
	...
	function theme_js(){
		...
		wp_register_script('waypoints',
		 ...
		 wp_register_script('waypoints-sticky',
			get_template_directory_uri() . '/library/js/waypoints-sticky.min',
			array('jquery'),
			'1.2' );
