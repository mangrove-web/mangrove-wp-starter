...
if( !function_exists("theme_styles") ) {
    function theme_styles() {
        // This is the compiled css file from LESS - this means you compile the LESS file locally and put it in the appropriate directory if you want to make any changes to the master bootstrap.css.
         wp_register_style( 'wp', get_template_directory_uri() . '/library/css/mg_custom.min.css', array(), '1.0', 'all' );
        wp_enqueue_style( 'wp' );

        wp_enqueue_style( 'fontawesome style', '//netdna.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.css' );
  ...
  function theme_js(){
    ...
    wp_register_script('waypoints',
     ...
     wp_register_script( 'wow',
      get_template_directory_uri() . '/library/js/wow.min.js'); //http://fitvidsjs.com/
